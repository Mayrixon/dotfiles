...
local function set_keymaps(mode, key, val)
  local opt = opts.generic_opts[mode] and opts.generic_opts[mode] or opts.fallback_opts
...
local function set_non_leader_keys()
  for mode, mapping in pairs(non_leader_keys.mappings) do
    map(mode, mapping)
  end
end
...
local function set_wk_keys()
  ...
  wk.register(leader_keys.normal_mappings, utils.get_prefix_opts("<leader>", n_opts))
  wk.register(leader_keys.visual_mappings, utils.get_prefix_opts("<leader>", v_opts))

  wk.register(localleader_keys.normal_mappings, utils.get_prefix_opts("<localleader>", n_opts))
  wk.register(localleader_keys.visual_mappings, utils.get_prefix_opts("<localleader>", v_opts))
