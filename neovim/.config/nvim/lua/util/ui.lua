...
function M.statuscolumn()
  ...
  local show_open_folds = vim.g.myvim_statuscolumn and vim.g.myvim_statuscolumn.folds_open
  local use_githl = vim.g.myvim_statuscolumn and vim.g.myvim_statuscolumn.folds_githl
  ...
  if show_signs then
    ...
    vim.api.nvim_win_call(win, function()
      ...
      elseif
        show_open_folds
        and not MyVim.ui.skip_foldexpr[buf]
