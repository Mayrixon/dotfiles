...
function M.rename_file()
  ...
  local old = assert(MyVim.root.realpath(vim.api.nvim_buf_get_name(buf)))
  local root = assert(MyVim.root.realpath(MyVim.root.get({ normalize = true })))
